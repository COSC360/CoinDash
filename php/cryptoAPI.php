        ...
        curl_close($curl);
            ...
            if ($err) {
                ...
                if ($con->connect_error) {
                    ...
                    $insertStmt->bind_param("ssssssssssssss", $img_url,$usd, $cad,$eur,$php,$jpy,$price_change_24h,$price_change_7d,$price_change_14d,$price_change_30d,$price_change_60d,$price_change_200d,$price_change_1yr,$field['Id']); 
                    $insertStmt->execute();
